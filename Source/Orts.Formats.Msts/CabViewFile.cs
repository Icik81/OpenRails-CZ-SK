...
namespace Orts.Formats.Msts
{
    ...
    public enum CABViewControlTypes
    {
        ...
        ORTS_AVV_PASS_STATION,
        ORTS_AVV_STOP_40,
        ORTS_AVV_EXPECT_SPEED,
        ORTS_SCREEN_BUTTON,
        SELECTED_SYSTEM,
        SELECTING_SYSTEM,
        SYSTEM_ANNUNCIATOR,
        ...
        DIESEL_DIRECTION_CONTROLLER3,
        DIESEL_DIRECTION_CONTROLLER4,
        ...
        HV4VOLTAGESETUP,
        DOORSWITCH,
        DOORSWITCH_PAXREQUEST,
        DOORSWITCH_UNLOCKSIGNAL,
        POWER_OFFCLOSINGON,
        HIGHVOLTAGE_DCOFFAC,
        LAP_BUTTON,
        DIRECTION_BUTTON,
        ...
        TRACTIONMOTORS_TEMPERATURE,
        DRIVERESISTANCE_TEMPERATURE,   
        MU_WHEELSLIPWARNING,
        MU_WHEELSLIP,
        MIRELRS_CONTROLLER,
        MIRELRS_DISPLAY,
        ...
        AXLECOUNTERSELECT_DISPLAY,
        AXLECOUNTER_DISPLAY,
        AXLECOUNTER_DISPLAY_UP,

...
//        [GetString("Game Switch Behind")] GameSwitchBehind,
        ...
        [GetString("Control Set Power Supply Station Location")] ControlPowerStationLocation,
        ...
        // Icik
        [GetString("Control HV2 1-system +")] ControlHV2SwitchUp,
        [GetString("Control HV3 2-system +")] ControlHV3SwitchUp,
        [GetString("Control HV3 2-system -")] ControlHV3SwitchDown,
        [GetString("Control HV5 2-system +")] ControlHV5SwitchUp, 
        [GetString("Control HV5 2-system -")] ControlHV5SwitchDown,
        [GetString("Control Pantograph3 +")] ControlPantograph3SwitchUp,
        [GetString("Control Pantograph3 -")] ControlPantograph3SwitchDown,
        [GetString("Control Pantograph4 +")] ControlPantograph4SwitchUp,
        [GetString("Control Pantograph4 -")] ControlPantograph4SwitchDown,
        ...
        [GetString("Control Heating Off/On")] ControlHeating_OffOn,
        [GetString("Control Heating in Cab Off/On")] ControlCabHeating_OffOn,
        [GetString("Control Locomotive PowerVoltage 25kV/both/3kV")] ControlRouteVoltage,
        [GetString("Control Quickrelease button")] ControlQuickReleaseButton,
        [GetString("Control Lowpressurerelease button")] ControlLowPressureReleaseButton,
        [GetString("Control Breakpower button")] ControlBreakPowerButton,
    }
}

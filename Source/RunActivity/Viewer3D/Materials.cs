    ...
    public class SceneryMaterial : Material
    {
        ...
        public override void SetState(GraphicsDevice graphicsDevice, Material previousMaterial)
        {
            ...
            if (NightTexture != null && NightTexture != SharedMaterialManager.MissingTexture && (((Options & SceneryMaterialOptions.UndergroundTexture) != 0 &&
                (Viewer.MaterialManager.sunDirection.Y < -0.035f /*|| Viewer.Camera.IsUnderground*/ || Viewer.Simulator.CabInDarkTunnel)) || Viewer.MaterialManager.sunDirection.Y < 0.0f - ((float)KeyLengthRemainder()) / 5000f))
            {

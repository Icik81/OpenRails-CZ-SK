...
namespace Orts.Viewer3D.Popups
{
    public class CarOperationsWindow : Window
    {
        ...
        public CarOperationsWindow(WindowManager owner)
            : base(owner, Window.DecorationSize.X + owner.TextFontDefault.Height * 23, Window.DecorationSize.Y + 2 + owner.TextFontDefault.Height * 22 + ControlLayout.SeparatorSize * 11, Viewer.Catalog.GetString("Car Operation Menu"))
        {
            Viewer = owner.Viewer;
        }
        ...
        void buttonBrakeCarDeactivate_Click(Control arg1, Point arg2)
        {
            ...
            Viewer.PlayerTrain.PlayerTrainBrakePercentChange = true;
        }

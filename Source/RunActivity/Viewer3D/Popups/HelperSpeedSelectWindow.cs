...
namespace Orts.Viewer3D.Popups
{
    public class HelperSpeedSelectWindow : Window
    {
        ...
        public HelperSpeedSelectWindow(WindowManager owner)
            : base(owner, Window.DecorationSize.X + owner.TextFontDefault.Height * 13, Window.DecorationSize.Y + (owner.TextFontDefault.Height * 8) + (ControlLayout.SeparatorSize * 7), Viewer.Catalog.GetString("Helper Speed Select"))
        {
            Viewer = owner.Viewer;
        }

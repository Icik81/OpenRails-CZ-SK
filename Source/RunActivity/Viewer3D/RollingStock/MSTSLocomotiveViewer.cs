    ...
    public class CabViewGaugeRenderer : CabViewControlRenderer
    {
            ...
            : base(viewer, locomotive, control, shader)
        {
            ...
            if ((Control.ControlType == CABViewControlTypes.REVERSER_PLATE) || (Gauge.ControlStyle == CABViewControlStyles.POINTER))
            {
                ...
                Texture = CABTextureManager.GetTexture(Control.ACEFile, false, Locomotive.CabFloodLightOn[Locomotive.LocoStation], Locomotive.CabLightOn[Locomotive.LocoStation] && dashLight, out IsNightTexture, HasCabLightDirectory);
            ...
            : base(viewer, locomotive, control, shader)
        {
            ...
            Texture = CABTextureManager.GetTexture(control.FireACEFile, false, Locomotive.CabFloodLightOn[Locomotive.LocoStation], Locomotive.CabLightOn[Locomotive.LocoStation] && dashLight, out IsNightTexture, HasCabLightDirectory);
            DrawColor = Color.White;
            SourceRectangle.Width = (int)Texture.Width;
            SourceRectangle.Height = (int)Texture.Height;
            IsFire = true;
    ...
    public class CabViewDiscreteRenderer : CabViewControlRenderer, ICabViewMouseControlRenderer
    {
        ...
        public virtual int GetDrawIndex()
        {
            ...
            switch (ControlDiscrete.ControlType)
            {
                ...
                case CABViewControlTypes.REQUESTED_FORCE:
                    ...
                    {
                        if (Locomotive.ControllerVolts < 0 && Locomotive.PositiveMask)
                            index = 1;
                        else
                            index = 0;
                        break;
                    ...
                    {
                        if (Locomotive.ControllerVolts > 0 && Locomotive.NegativeMask)
                            index = 1;
                        else
                            index = 0;
                        break;
        ...
        public void HandleUserInput()
        {
            ...
            switch (Control.ControlType)
            {
                ...
                case CABViewControlTypes.ARIPOT_CONTROLLER:
                    // Aripot
                    if (Locomotive.CruiseControl != null && Locomotive.CruiseControl.AripotEquipment && !Locomotive.AripotControllerCanUseThrottle[Locomotive.LocoStation])
                    {
                        if (ChangedValue(0) > 0)                        

...
namespace Orts.Simulation.RollingStocks.SubSystems.Controllers
{
    public class ScriptedBrakeController : IController
    {
        ...
        // Iciks
        public float RunningReleaseRatePSIpS { get; private set; }
        ...
        public void Parse(string lowercasetoken, STFReader stf)
        {
            ...
            {
                // Iciks
                case "engine(trainbrakescontrollermaxrunningreleaserate":
                    RunningReleaseRatePSIpS = stf.ReadFloatBlock(STFReader.UNITS.PressureRateDefaultPSIpS, null);
                    break;

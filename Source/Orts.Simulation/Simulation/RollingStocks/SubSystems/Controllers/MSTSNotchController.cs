...
namespace Orts.Simulation.RollingStocks.SubSystems.Controllers
{
    public class MSTSNotch
    {
        ...
        public MSTSNotch(float v, int s, string type, STFReader stf)
        {
            ...
            switch (lower)
            {
                ...
                case "westinghousereleasestart": Type = ControllerState.WestingHouseRelease; break;
    ...
    public class MSTSNotchController : IController
    {
        ...
        {
            // Icik             
            StepSize = MathHelper.Clamp(StepSize, 0.01f, 1);
        ...
        public float GetNotchFraction()
        {
            ...
            if (notch.Type == ControllerState.Release || notch.Type == ControllerState.WestingHouseRelease)
                x = 1 - x;
            return x;
        }

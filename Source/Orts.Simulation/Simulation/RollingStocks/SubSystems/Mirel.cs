    ...
    public class Mirel
    {
        ...
        public void Update(float elapsedClockSeconds, float AbsSpeedMpS, float AbsWheelSpeedMpS)
        {
            ...
            { 
                ...
                if (firstRun && MirelType == Type.Full)
                {
                    Locomotive.SignalEvent(Common.Event.MirelBrakeReleasingPipePressure);
                    firstRun = false;
                }
        ...
        protected void MirelCheck(float elapsedTimeSeconds)
        {
            ...
            if ((selectedDriveMode == DriveMode.Normal || recieverState == RecieverState.Off) && selectedDriveMode != DriveMode.Trailing) 
            {
        ...
        private void CheckNZ5(float ElapsedClockSeconds)
        {
            ...
            if ((Locomotive.EngineBrakeController.CurrentValue > 0 || Bar.FromPSI(Locomotive.BrakeSystem.BrakeLine1PressurePSI) < 4.5 || Locomotive.AbsSpeedMpS > 0) && !NZ5)
            {

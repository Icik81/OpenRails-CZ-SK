    ...
    public class AirSinglePipe : MSTSBrakeSystem
    {
        ...
        public override void Parse(string lowercasetoken, STFReader stf)
        {
            switch (lowercasetoken)
            {
                ...
                // Definování neutrálních poloh u přímočinky                              
        ...
        protected static void PropagateBrakeLinePressures(float elapsedClockSeconds, TrainCar trainCar, bool twoPipes)
        {
            ...
            if (lead != null)
            {
                ...
                //if (EngineBrakeControllerRate > EngineBrakeControllerRelease
                //    && EngineBrakeControllerRate < EngineBrakeControllerApply)

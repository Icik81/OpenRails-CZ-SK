...
namespace ORTS.Scripting.Api
{
    public abstract class BrakeController : AbstractScriptClass
    {
        ...
        /// <summary>
        /// Running release rate of the equalizing reservoir
        /// </summary>
        ...
        // Iciks
        /// <summary>
        /// RunningRelease rate of the equalizing reservoir
        /// </summary>
        public Func<float> RunningReleaseRateBarpS;
    }
    ...
    public static class ControllerStateDictionary
    {
        ...
        public static readonly Dictionary<ControllerState, string> Dict = new Dictionary<ControllerState, string>
        {
            ...
            {ControllerState.ManualBraking, Catalog.GetString("Ruční brzdění")},
